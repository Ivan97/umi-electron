  ...
  return (
    <PageContainer>
      ...
      >
        ...
        <ProCard bordered={true} colSpan={12}>
          <div className="tabs">
            <a className="tab tab-lifted indicator tab-active space-x-2">
              <SpinIcon />
              <span>Messages</span>
              <span className="indicator-item badge">6</span>
            </a>
            <a className="indicator tab tab-lifted ">Notifications</a>
        ...
        <ProCard bordered={true} colSpan={12}>
          <div className="tabs">
            ...
            <a className="indicator tab tab-lifted tab-active space-x-2">
              <SpinIcon />
        ...
        <ProCard>
          <div className="indicator">
            ...
            <div className="card border border-solid border-gray-100 shadow-xl">
